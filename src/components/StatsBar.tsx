...
function StatCard({ label, shortLabel, value, icon, gradient, glow, textGradient, index }: StatCardProps) {
  return (
    ...
    >
      ...
      {/* Icon */}
      <div className={`relative flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br ${gradient} ${glow} shadow-lg flex-shrink-0`}>
  ...
  return (
    <div className="grid grid-cols-3 gap-2 sm:gap-4">
      ...
      <StatCard
        ...
        textGradient="from-amber-500 to-orange-500 dark:from-amber-400 dark:to-orange-400"
        index={1}
      />
      <StatCard
        label="Completed"
