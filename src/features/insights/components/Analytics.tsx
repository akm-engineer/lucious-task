  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5 px-5 py-4 border-b border-slate-100/70 dark:border-white/[0.06]">
        ...
        <h2 className="text-sm font-black text-slate-800 dark:text-white tracking-tight">Insights</h2>
        <span className="ml-auto text-[11px] font-semibold text-slate-400 dark:text-slate-500">All time · this week</span>
      </div>
      ...
      <div className="p-4 sm:p-5 space-y-5">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-3">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.92 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.05, duration: 0.4 }}
          ...
          <motion.div initial={{ opacity: 0, scale: 0.92 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.12, duration: 0.4 }}
            ...
            <div className="relative flex items-center justify-center">
              <Ring pct={stats.completionRate} color="#10b981" trackColor="rgba(16,185,129,0.15)" size={60} stroke={6} />
            ...
            <div className="flex items-center gap-1">
              ...
              <p className="text-[10px] sm:text-xs font-bold text-emerald-600 dark:text-emerald-400">Completion</p>
            </div>
          </motion.div>

          <motion.div initial={{ opacity: 0, scale: 0.92 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.19, duration: 0.4 }}
            ...
            <div className="relative flex items-center justify-center">
              <Ring pct={stats.productivity} color="#f59e0b" trackColor="rgba(245,158,11,0.15)" size={60} stroke={6} />
            ...
            <div className="flex items-center gap-1">
              ...
              <p className="text-[10px] sm:text-xs font-bold text-amber-600 dark:text-amber-400">On-Time</p>
            </div>
          </motion.div>
        ...
        <div>
          <p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-3">Activity — Last 7 Days</p>
              ...
              return (
                <div key={i} className="flex-1 flex flex-col items-center gap-1.5 h-full justify-end">
                  <div className="w-full flex flex-col justify-end" style={{ height: 'calc(100% - 20px)' }}>
                    <motion.div
                      ...
                      className={`w-full rounded-t-lg origin-bottom transition-all ${
                        isToday ? 'bg-gradient-to-t from-violet-600 to-indigo-400 shadow-md shadow-indigo-500/30' :
                        count > 0 ? 'bg-gradient-to-t from-violet-400/60 to-indigo-300/60 dark:from-violet-700/60 dark:to-indigo-600/60' :
                  ...
                  <span className={`text-[10px] font-bold ${
                    ...
                    isWeekend ? 'text-slate-300 dark:text-slate-600' :
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 mt-1">
            {stats.activity.map((count, i) => (
              <div key={i} className="flex-1 text-center">
                {count > 0 && <span className="text-[9px] font-bold text-slate-400 dark:text-slate-500">{count}</span>}
              </div>
            ))}
          </div>
        </div>
